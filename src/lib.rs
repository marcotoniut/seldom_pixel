...
///
/// Use this for headless integration tests or server builds where game logic needs `seldom_pixel`
...
/// Add to your [`App`] to enable `seldom_pixel` with full rendering support. The type parameter
