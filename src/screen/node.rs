...
impl<L: PxLayer> ViewNode for PxRenderNode<L> {
    ...
    fn run<'w>(
        ...
        let _collect_span = px_trace_span!("seldom_pixel::screen_node::collect");
        ...
        px_trace!(
            ...
            "seldom_pixel::screen_node::draw"
        );

        {
            let _draw_span = px_trace_span!("seldom_pixel::screen_node::draw_layers");
            #[cfg(feature = "gpu_palette")]
            draw::draw_layers(
                world,
                render_buffer,
        ...
        let _upload_span = px_trace_span!("seldom_pixel::screen_node::upload");
        ...
        let _present_span = px_trace_span!("seldom_pixel::screen_node::present");
