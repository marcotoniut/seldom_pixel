...
impl<L: PxLayer> ViewNode for PxGpuSpriteNode<L> {
    ...
    fn run<'w>(
        ...
        let _run_span = px_trace_span!(
            "seldom_pixel::gpu_sprite_node::run",
        ...
        let _collect_span = px_trace_span!("seldom_pixel::gpu_sprite_node::collect");
        ...
        px_trace!(
            ...
            estimated_items,
            "seldom_pixel::gpu_sprite_node::collected"
        );

        let _build_span = px_trace_span!("seldom_pixel::gpu_sprite_node::build");
        ...
        px_trace!(
            ...
            "seldom_pixel::gpu_sprite_node::prepared"
        );

        let _upload_span = px_trace_span!("seldom_pixel::gpu_sprite_node::upload");
        ...
        let _present_span = px_trace_span!("seldom_pixel::gpu_sprite_node::present");
